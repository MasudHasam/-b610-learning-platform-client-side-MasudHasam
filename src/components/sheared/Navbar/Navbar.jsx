        ...
        <div className="navbar bg-orange-200">
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal p-0">
                    <li><NavLink className={'font-bold text-orange-700'} to='/home'>Home</NavLink></li>
                    <li><NavLink className={'font-bold text-orange-700'} to='/courses'>Courses</NavLink></li>
                    <li><NavLink className={'font-bold text-orange-700'} to='/blog'>Blog</NavLink></li>
                    <li><NavLink className={'font-bold text-orange-700'} to='/faq'>FAQ</NavLink></li>
            ...
            <div className="navbar-end">
                <NavLink to='/courses'><BsCartCheck className='mr-2 w-6 h-6'></BsCartCheck></NavLink>
                {
                    user && user?.photoURL ?
